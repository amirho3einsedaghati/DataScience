...
so it may be relevant to cite both the methodsoverview journal article as well 
as the specific version of the dataset used.

The journal article describing GHCN-Daily is
Menne, M.J., I. Durre, R.S. Vose, B.E. Gleason, and T.G. Houston, 2012  An overview 
of the Global Historical Climatology Network-Daily Database.  Journal of Atmospheric 
and Oceanic Technology, 29, 897-910, doi10.1175JTECH-D-11-00103.1.
...
e.g. Version 3.12]. 
NOAA National Climatic Data Center. httpdoi.org10.7289V5D21VHZ [access date].
--------------------------------------------------------------------------------
...
II. CONTENTS OF ftpftp.ncdc.noaa.govpubdataghcndaily
...
by_year              Directory with GHCN Daily files parsed into yearly
		      ...
		      by_yearreadme.txt and 
		      by_yearghcn-daily-by_year-format.rtf 
...
QFLAG1     is the quality flag for the first day of the month.  There are 
           ...
           K     = failed streakfrequent-value check
...
SFLAG1     is the source flag for the first day of the month.  There are 
	   ...
	   s     = China Meteorological AdministrationNational Meteorological Information Center
	           Climatic Data Center (httpcdc.cma.gov.cn)
	   ...
	   u     = Ukraine update	   
	   W     = WBANASOS Summary of the Day from NCDC's Integrated 
	           Surface Data (ISD).  
...
ID         is the station identification code.  Note that the first two
	   ...
	   See ghcnd-states.txt for a list of stateprovinceterritory codes.
...
CODE       is the FIPS country code of the country where the station is 
           ...
           www.cia.govciapublicationsfactbookappendixappendix-d.html).
...
CODE       is the POSTAL code of the U.S. stateterritory or Canadian 
...
Data and metadata available at httpeca.knmi.nl
